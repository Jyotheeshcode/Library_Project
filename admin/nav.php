<nav class="main-menu">
      ...
      <ul>
        ...
        <li>
          <a href="student.php">
            <i class="fa fa-tasks fa-lg nav-logo"></i>
        ...
        <li class="darkerli">
          <a href="addbook.php">
            <i class="fa fa-plus-square fa-lg nav-logo"></i>
        ...
        <li class="darkerli">
          <a href="requests.php">
            ...
            <span class="nav-text">Issue/Return Books</span>
          </a>
        </li>
        ...
        <li class="darkerli">
          <a href="recommendations.php">
            ...
            <span class="nav-text">Book Recommendations</span>
          </a>
        </li>
